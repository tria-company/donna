...
export const metadata: Metadata = {
  ...
  keywords:
    'Donna careers, Donna jobs, AI startup jobs, autonomous company jobs, San Francisco AI jobs, agent engineering, startup hiring',
  openGraph: {
    title: 'Careers at Donna – Build the Autonomous Company OS',
    description:
